...
```bash
# Lighthouse CLI
Use the repository's installed performance tool or the native browser tools against the local URL; do not add a global dependency merely for this check.
