...
- Launch-day monitoring checklists and rollback triggers — use the ship command and the project runbook; this skill covers the instrumentation that feeds them
