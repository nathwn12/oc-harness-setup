...
**Related:** For browser-based changes, combine this workflow with runtime verification using the native browser tools — see the Browser Testing section below.
...
For anything that runs in a browser, unit tests alone aren't enough — you need runtime verification. Use the harness browser tools for DOM inspection, console logs, network requests, performance sampling, and screenshots where available.
...
For detailed DevTools setup instructions and workflows, use the native DevTools tooling directly.
